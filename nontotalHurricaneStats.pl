...
# @version    $Header$
# @cdaacTask  no
# @usage      nontotalHurricaneStats.pl storm_name mission
# @example    nontotalHurricaneStats.pl KENNETH champ
# -----------------------------------------------------------------------*/
EOD
...
my $args = {RESULTS   => \@all_time_steps,
            ...
            PLOT      => "$storm.minus7.$mission.gfs.png/PNG",   # name of plot file
...
open(OUT,">$storm.$mission.minus7.gfs.txt");
